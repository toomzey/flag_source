...
export const FLAG_CONTROLS: any = {
  ...
  physics: {
    ...
    flatness: [0, 0, 1, 0.01],
    gravity: [0, 0, 1.5, 0.01],
    windStrength: [0.21, 0, 2, 0.01],
    windWaveStrength: [0.67, 0, 2, 0.01],
    windWaveFrequency: [7.5, 1, 8, 0.25],
    windTurbulence: [2, 0, 2, 0.01],
    viscosity: [0, 0, 0.6, 0.005],
    stiffness: [0.2, 0.2, 1, 0.01],
    iterations: [4, 1, 14, 1],
    smoothing: [0.012, 0, 0.3, 0.002],
    grabRadius: [0.24, 0.05, 1.2, 0.01],
  },
  images: {
    _collapsed: true,
    useImage: false,
